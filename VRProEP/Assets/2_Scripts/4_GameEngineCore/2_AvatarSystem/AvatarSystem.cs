...
namespace VRProEP.GameEngineCore
{
    ...
    public static class AvatarSystem
    {
        ...
        public static void LoadAvatar(UserData userData, AvatarType avatarType, bool isNew = true, bool useController = true, bool mocap = false)
        {
            ...
            else if (avatarType == AvatarType.AbleBodied)
            {
                ...
                {
                    AvatarSpawner.SpawnAbleBodiedAvatar(userData, activeAvatarData, isNew, useController, mocap);
                }
            }
