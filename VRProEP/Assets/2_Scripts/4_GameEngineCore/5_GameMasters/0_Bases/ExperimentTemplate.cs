...
public class ExperimentTemplate : GameMaster
{
    ...
    {
        Debug.Log("InitialiseExperimentSystems");
    ...
    public override IEnumerator InstructionsLoop()
    {
        ...
        yield return new WaitForSecondsRealtime(2.0f); // Wait for some time.
        //
